(function(){
  ...
  function updatePositions() {
    let currentBottom = 20; // отступ от низа
  ...
  function showMessage(msg, isError=false, isSuccess=false, duration=2000){
    ...
    // Ждем рендер, чтобы offsetHeight был корректен
  ...
  // --- экспорт функций для скриптов ---
  window.showNotif = showMessage;
  window.showErrorNotif = showError;
  window.showSuccessNotif = showSuccess;
